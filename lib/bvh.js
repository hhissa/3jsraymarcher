...
export class BVHFactory {
    ...
    buildBVH(objects) {
        ...
        objects.sort((a, b) => a.min.z - b.min.z);
    ...
    flattenBVHTexture(objects, SDFS) {
        ...
        objects.forEach((node, i) => {
            ...
            AABBArray.set([
                ...
                node.AABB.index, node.left === null ? -1 : node.left.AABB.index, node.right === null ? -1 : node.right.AABB.index, SDFIndex
            ], i * 12);
        });
    ...
    createObjectTexture(objects) {
        ...
        objects.forEach((object, i) => {
            SDFArray.set([
                object.pos.x, object.pos.y, object.pos.z, object.type,
